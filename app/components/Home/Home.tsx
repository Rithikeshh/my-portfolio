...
import image1 from '../../assets/images/farzad-p-xSl33Wxyc-unsplash.jpg'
import image2 from '../../assets/images/clark-tibbs-oqStl2L5oxI-unsplash.jpg'
import image3 from '../../assets/images/image-3.webp'
import image4 from '../../assets/images/clint-patterson-dYEuFB8KQJk-unsplash.jpg'
import image5 from '../../assets/images/image-4.webp'
import Aos from "aos";
  ...
  return (
    <div className={styles.container} data-aos="fade-down">
        ...
        <div className='mt-6 mb-8'>
            <p data-aos="fade-down" className='font-bold text-4xl max-[860px]:text-3xl max-[540px]:text-2xl text-[rgba(255,255,255,.9)] dark:text-zinc-800'>
                Frontend developer, fullstack developer , backend developer and amature debugger.
            </p>
        </div>
        
        <div data-aos="fade-left" className='text-[rgba(255,255,255,.6)] dark:text-zinc-800/80'>
        ...
        <div data-aos="fade-up" className='flex gap-4 mt-2'>
            ...
            <a href="https://github.com/Rithikeshh" target='_blank'>
            ...
            <a href="https://www.linkedin.com/in/alok-shaw-b57a7426a/" target='_blank'>
        ...
        <div className='relative mt-14 h-[360px] max-[1000px]:h-[240px]'>
            <div data-aos="flip-up" className={styles.imagesContainer}>
                <Image 
                    ...
                    className='rotate-2 origin-top-left aspect-square max-[1000px]:w-[190px] duration-300 ease-in hover:rotate-0'
                />
                <Image 
                    src={image2}
                    alt=''
                    ...
                    className='-rotate-2 origin-bottom aspect-square max-[1000px]:w-[190px] duration-300 ease-in hover:rotate-0'
                />
                <Image 
                    src={image3}
                    alt=''
                    ...
                    height={320}
                    style={{borderRadius: '16px', objectFit: 'cover'}}
                    className='rotate-1 origin-top-left aspect-square max-[1000px]:w-[190px] duration-300 ease-in hover:rotate-0'
                />
                <Image 
                    src={image4}
                    alt=''
                ...
                <Image 
                    ...
                    height={320}
                    style={{borderRadius: '16px', objectFit: 'cover'}}
                    className='-rotate-1 origin-bottom aspect-square max-[1000px]:w-[190px] duration-300 ease-in hover:rotate-0'
                />
            </div>
        </div>
    </div>
